...
sy_2015 <- fread("toddAbraham/schools_2015_DSPG_2020.csv", check.names = TRUE)
sy_2016 <- fread("toddAbraham/schools_2016_DSPG_2020.csv", check.names = TRUE)
sy_2017 <- fread("toddAbraham/schools_2017_DSPG_2020.csv", check.names = TRUE)
