...
#note the sep="" is added to keep a space from appearing in the path
...
df #this only prints a subset of the data frame as there is a max that can be printed.

#to see just the header and first six row of the data
head(df)
