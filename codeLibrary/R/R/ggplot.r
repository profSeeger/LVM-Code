...
# the two commands below will manually load in the packages and corresponding libraries

# ggplot is used to make graphics - it is better then base R's built in graphics
